  ...
  return (
    <aside className="sticky w-48 sm:block hidden text-font-gray">
      <div className="flex flex-col bg-grey">
        ...
        <span className="my-1 pl-3 text-xs">PUBLIC</span>
        <ul>
          ...
          {["Tags", "Users", "Companies"].map((a, idx) => (
            <li
              key={idx}
              className="flex items-center text-sm h-10 w-48 pl-10 cursor-pointer hover:text-black"
            >
              <div>{a}</div>
            </li>
          ))}
