...
public enum ExceptionCode {
    ACCOUNT_NOT_FOUND(404, "사용자를 찾을 수 없습니다."),//사용자를 찾을 수 없음
    ...
    ACCOUNT_EXISTS(409, "이미 존재하는 사용자 입니다."),//이미 존재하는 사용자
    ...
    BOARD_NOT_FOUND(404,"게시글을 찾을 수 없습니다."),//게시글을 찾을 수 없음
    BOARD_EXISTS(409, "이미 게시글이 존재합니다."),//게시글이 이미 존재함
    BOARD_TITLE_NOT_FOUND(400, "제목을 입력하세요"),//게시글제목을 작성하지 않음
    BOARD_CONTENT_NOT_FOUND(400, "내용을 입력하세요"),//게시글 본문을 작성하지 않음
    ANSWER_NOT_FOUND(404, "답변을 찾을 수 없습니다."),//답변을 찾을 수 없음
    ANSWER_EXISTS(409, "이미 답변이 존재합니다."),//이미 답변이 존재함
